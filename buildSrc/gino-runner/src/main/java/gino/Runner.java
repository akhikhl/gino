...
public class Runner {
  ...
  public static Object run(String scriptFileName, Object[] args, ClassLoader classLoader, Object logger, boolean initServices, String homeFolder) throws IOException {
    Object result;
    ...
    try {
      ...
      Object[] bootArgs = new Object[] {
          Context.javaToJS(scriptFileName, scope),
          Context.javaToJS(args, scope),
          Context.javaToJS(initServices, scope),
          Context.javaToJS(homeFolder, scope)
      };
